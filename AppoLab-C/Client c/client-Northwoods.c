...
int main() {
    ...
    char txt[MAXREP]; char passe[32]; char enc[MAXREP]; 
    ...
    printf("\n%s\n", txt);
    txt[0] = '\0';
    crypteSeq_encoder("There will be no Nineteen Eighty-Four", enc);

    envoyer_recevoir(enc, reponse);
    crypteSeq_decoder(reponse + 24, txt);
    printf("\n%s\n", txt);
    txt[0] = '\0';
